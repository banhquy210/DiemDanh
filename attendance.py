...
class Attendance:
    def __init__(self,root):
        self.root = root
        self.root.geometry("1195x763+0+0")
...
#=======vảiable=====
        ...
        #Bg image
        img3 = Image.open(r"assets/img/bg_atten.png")
        ...
        main_frame.place(x = 25, y = 110, width = 1145, height = 630)

        #Left frame
        Left_frame = ttk.Labelframe(main_frame, text = "Thông tin điểm danh sinh viên")
        Left_frame.place(x = 10, y = 10, width =555, height =  610)
        ...
        #Roll
        roll_label = ttk.Label(left_insider_frame, text = "CMND:")
        ...
        self.attendance_status["values"] = ("", "Vao lop", "Di tre")
...
#Buttom frame
        ...
        Right_frame.place(x = 580, y = 10, width =555, height =  610)
        ...
        table_frame.place(x = 5, y = 140, width =543, height =  450)
        ...
        self.AttendanceReportTable.heading("roll", text = "CMND")
