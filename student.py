...
class Student:
    def __init__(self,root):
        ...
        #Bg image
        img3 = Image.open(r"assets/img/bg_ifsv.png")
        ...
        dep_combo["values"] = ("", "Big Data & Machine Learning", "Cong nghe phan mem", "Mang may tinh", "Thiet ke do hoa")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("", "Chuong trinh thuong", "Chuong trinh tai nang - HP", "Dao tao quoc te - CMU", "Dao tao quoc te - PSU")
        ...
        semester_combo["values"] = ("", "Hoc ki I", "Hoc ki II", "Hoc ki He")
        ...
        # Roll No
        roll_no_label = ttk.Label(class_student_frame, text = "CMND")
        ...
        save_btn = ttk.Button(btn_frame, text ="Lưu", command = self.add_data, style="ToggleButton", width = 15)
        save_btn.grid(row = 0, column = 0, padx = 7)

        update_btn = ttk.Button(btn_frame, text ="Cập nhật", command = self.update_data, style="ToggleButton", width = 15)
        update_btn.grid(row = 0, column = 1, padx = 10)


        delete_btn = ttk.Button(btn_frame, text ="Xoá", command = self.delete_data, style="ToggleButton", width = 15)
        delete_btn.grid(row = 0, column = 2, padx = 10)

        reset_btn = ttk.Button(btn_frame, text = "Nhập lại", command = self.reset_data, style="ToggleButton", width = 15)
        ...
        take_photo_btn = ttk.Button(btn_frame1, text ="Chụp ảnh", command = self.generate_dataset, style="ToggleButton", width = 60)
        take_photo_btn.grid(padx = 70, pady = 0)
        ...
        search_label = ttk.Label(search_frame, text = "Tìm kiếm:", border = 3)
        ...
        search_combo["values"] = (" ", "Dep", "Division", "Student_ID")
        ...
        search_btn = ttk.Button(search_frame, text ="Tìm", command = self.search_data,style="ToggleButton", width = 10)
        search_btn.grid(row = 0, column = 3, padx = 7)

        showAll_btn = ttk.Button(search_frame, text ="Hiển thị", command = self.fetch_data,style="ToggleButton", width = 10)
        ...
        self.student_table.heading("sem", text = "Hoc ki")
